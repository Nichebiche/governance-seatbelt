...
const openBlockCallBytes = ArbTokenInterface.encodeFunctionData('transfer', [
  openBlockAddress,
  openBlockAmount,
]);
const gauntletCallBytes = ArbTokenInterface.encodeFunctionData('transfer', [
  gauntletAddress,
  gauntletAmount,
]);
const multisigCallBytes = ArbTokenInterface.encodeFunctionData('transfer', [
  multisigAddress,
  multisigAmount,
]);
