...
const bps2EnableForward = l2AccountForwarder.encodeFunctionData('forward', [
  v3FactoryAddress,
  bps2Enable,
]);
const bps3EnableForward = l2AccountForwarder.encodeFunctionData('forward', [
  v3FactoryAddress,
  bps3Enable,
]);
const bps4EnableForward = l2AccountForwarder.encodeFunctionData('forward', [
  v3FactoryAddress,
  bps4Enable,
]);
